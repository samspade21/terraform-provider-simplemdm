...
- `binary_file` (String) Path to app binary (ipa or pkg) to upload. Required when managing enterprise, custom B2B, or macOS package apps. Use either this, app_store_id, or bundle_id.
